...
$prv=$n-1;
if($prv > 0)
{echo "<a href='sreport.php?page=".$prv."&id=".$catid."'>".'Previous<'."</a> "; // Goto 1st page  
}
for ($i=1; $i<=$total_pages; $i++) { 
          echo "<a href='sreport.php?page=".$i."&id=".$catid."'>".$i."</a> "; 
            
}; 
$nxt=$page+1;
if($nxt <= $total_pages)
echo "<a href='sreport.php?page=".$nxt."&id=".$catid."'>".'>Next'."</a> "; // Goto last page
echo '</p>';
?>
            </div>
        </div>  
