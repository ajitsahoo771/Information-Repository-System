 ...
 <?php include("mheader.php"); ?>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td><a href="view.php?filename=<?php echo $name ;?>" target="_NEW">
        <img src="images/view3.png" height="38px" width="38px"></img></a></td>
...
$prv=$n-1;
if($prv > 0)
{echo "<a href='mreport.php?page=".$prv."&id=".$catid."'>".'Previous<'."</a> "; // Goto 1st page  
}
for ($i=1; $i<=$total_pages; $i++) { 
          echo "<a href='mreport.php?page=".$i."&id=".$catid."'>".$i."</a> "; 
            
}; 
$nxt=$page+1;
if($nxt <= $total_pages)
echo "<a href='mreport.php?page=".$nxt."&id=".$catid."'>".'>Next'."</a> "; // Goto last page
echo '</p>';
?>
            </div>
        </div>  
