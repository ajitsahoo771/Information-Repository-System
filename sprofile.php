...
<div id = "myTabContent" class = "tab-content">
   ...
   <div class = "tab-pane fade in active" id = "home">
      ...
      <img src="images/student.png" height="100px" width="150px" style="margin-top:20px;margin-left: 10px"></img>
         
        <p class="contentt">Student Profile</p>
          <table class="table"  style="background-color:#ffffff ;color: #63bbfa;font-size: 18px;font-family: 'Bree Serif', serif;font-size:20px" >
              <tr>
                  <td>Name: <font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $sname; ?></td>
                  <td></td>
              </tr>
               <tr>
                  <td>Registration Number:<font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $d; ?></td>
                  <td></td>
              </tr>
              <tr>
                  <td>Email Id:<font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $semail; ?></td>
                  <td></td>
              </tr>
               <tr>
                  <td>Department:<font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $sdept; ?></td>
                  <td></td>
              </tr>
              <tr>
                  <td>Section:<font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $ssec; ?></td>
                  <td></td>
              </tr>
              <tr>
                  <td>Batch:<font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $sbatch; ?></td>
                  <td></td>
              </tr>
              <tr>
                  <td>Contact Number:<font style="color: #5a5b5b;font-family: 'Bree Serif'"><?php echo $scon; ?></td>
                  <td></td>
              </tr>
          </table>
      </p>
         ...
         <div class = "tab-pane fade"id="upl" >
             <p>
               <form enctype="multipart/form-data" action="uploadfile.php" name="form" method="post">
...
$prv=$n-1;
if($prv > 0)
{echo "<a href='sprofile.php?page=".$prv."'>".'Previous<'."</a> "; // Goto 1st page  
}
for ($i=1; $i<=$total_pages; $i++) { 
          echo "<a href='sprofile.php?page=".$i."'>".$i."</a> "; 
            
}; 
$nxt=$page+1;
if($nxt <= $total_pages)
echo "<a href='sprofile.php?page=".$nxt."'>".'>Next'."</a> "; // Goto last page
echo '</p>';
...
<form name="login-form" action="changepassword.php" method="post" >
<table class="table"  style="background-color:#ffffff ;color: #63bbfa;font-size: 18px;margin-top: 10px;font-family: 'Bree Serif', serif;font-size:20px" >
