...
<body>
 <?php include("mheader.php"); ?>
    <div id="main" style="height:750px; background: url(images/bg.png) repeat;" >
        ...
        <div id="profile">
            <div class="profilee">
                <p class="contentt">  Registered Faculty/Staff List
...
mysql_select_db("irs",$con);
       $select = mysql_query("Select * From facstaff LIMIT $start_from, $num_rec_per_page");
       if($select === FALSE) { 
       die(mysql_error());}
...
if($prv > 0)
{echo "<a href='mfaculty.php?page=".$prv."'>".'Previous<'."</a> "; // Goto 1st page  
}
for ($i=1; $i<=$total_pages; $i++) { 
          echo "<a href='mfaculty.php?page=".$i."'>".$i."</a> "; 
            
}; 
$nxt=$page+1;
if($nxt <= $total_pages)
echo "<a href='mfaculty.php?page=".$nxt."'>".'>Next'."</a> "; // Goto last page
echo '</p>';
