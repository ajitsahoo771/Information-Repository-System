...
<body>
 <?php include("header.php"); ?>
    <div id="main" style="height:800px; background: url(images/bg.png) repeat;">
...
<form name="login-form" class="login-form" action="checkvalidate.php" method="post" onSubmit="return formValidation()">
    ...
    <div class="footer">
      <input type="submit" name="submit" value="Validate" class="button" /></a>
