...
<div class="banner">	  
	 <div class="header">
			 <div class="logo" style="margin-left:120px">
				<a href="index.php"><img src="images/Logo.gif" alt="" height="200px" width="180px" /></a>
			 </div>
			 ...
			 <div class="top-menu">
				 ...
				 <ul class="navig">
					 <li class="active"><a href="index.php">Home</a></li>
                                         <li><a href="http://localhost/Forum/signin.php">Forum</a></li>
                                         ...
                                         <li><a href="#" class="arrow" style="margin-bottom: 13px">My Account</a>
                                              <div class="drop decor2_2" style="width: 100px;">
                                                    <div>
                                                        ...
                                                        <a href="validate.php">Register</a><br />
                                                    </div>
                                             </div>
                                         </li></ul>
				 </ul>
